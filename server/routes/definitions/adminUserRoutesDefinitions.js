...
router.get("/users/:id", isAuthenticated, isAdmin, AdminUserController.getUserById);
router.patch("/users/:id", isAuthenticated, isAdmin, AdminUserController.updateUser);
